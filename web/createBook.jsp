                                ...
                                <div class="row product-gallery mx-1">
                                    <div class="col-12 mb-0">
                                        <figure class="view overlay rounded z-depth-1 main-img">
                                            <a href="${param.urlImg}"
                                               data-size="710x823">
                                                <img id="img" style="max-width: 70%" src="${param.urlImg}"
                                    ...
                                    <span class="d-flex align-items-center">
                                        <p class="fw-bold text-primary" style="margin: 3px 5px 0 0">Select Image: </p>
                                        <input onchange="uploadImg()" id="file" type="file" name="txtImage" placeholder="Select new image">
                                        <input id="urlHidden" type="hidden" value="" name="urlImg"/>
                                    </span>
                                    <c:set var="emptyImage" value="${requestScope.EMPTY_IMG}" scope="request"/>
                                    <c:if test="${not empty emptyImage}">
                                        <p style="color: red">${emptyImage}</p>
                                        <c:remove var="emptyImage"/>
                                    </c:if>
                                </div>
                        ...
                        <div class="col-md-6">
                            <span>
                                <p class="fw-bold" style="margin-bottom: 0">Title:<p> 
                                    <input name="txtTitle" value="${param.txtTitle}" style="width: 100%"/><br/>
                            </span>
                            ...
                            <span>
                                <p class="fw-bold" style="margin-bottom: 0">Description:<p> 
                                    <textarea  name="txtDescription"  style="width: 100%; height: 200px">${param.txtDescription}</textarea>
                            </span>
                                ...
                                <table class="table table-sm table-borderless mb-0" style="font-size: 16px">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width: 100%" name="txtAuthor" value="${param.txtAuthor}"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="d-flex align-items-center">
                                                    <input style="margin-right: 5px; width: 100px" type="number" name="txtPrice" value="${param.txtPrice}"/> 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width: 100px" type="number" name="txtQuantity" value="${param.txtQuantity}"/>
                            ...
                            <hr>
                            <button type="submit" class="btn btn-success btn-md mr-1 mb-2">Create</button>
                        </div>
                    </div>
                </form>
